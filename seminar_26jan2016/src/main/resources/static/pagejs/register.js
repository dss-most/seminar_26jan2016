	...
	render: function() {
		...
		if(this.hasAuthenticated == false) {
			...
			$('#alertDanger').html("ท่านได้ลงทะเบียนการสัมมนาแล้ว รายละเอียดตามด้านล่าง" + 
					" สามารถตรวจสอบลำดับการลงทะเบียนหน้างานสัมมนาได้ที่เว็บนี้ ภายในวันที่ ๒๒ มกราคม ๒๕๕๙" +
					" หากมีข้อสงสัยหรือต้องการแก้ไขข้อมูล กรุณาติดต่อกลับมาที่อีเมล 125seminar@dss.go.th ภายในวันที่ ๒๒ มกราคม ๒๕๕๙");
			$('#alertDanger').show();
				...
				$.ajax({
					...
					success: function(data) {
						if(data == "OK") {
							...
							$('#alertDanger').removeClass('alert-danger');
							$('#alertDanger').addClass('alert-success');
							$('#alertDanger').html("การลงทะเบียนเรียบร้อย ขอบคุณท่านที่ลงทะเบียน และท่านสามารถตรวจสอบลำดับการลงทะเบียนหน้างานได้ที่เว็บไซต์นี้ ภายในวันที่ ๒๒ มกราคม ๒๕๕๙");
							$('#alertDanger').show();
						}
					}
				});
